...
exports.ManageClient = void 0;
const AbstractRestfulClient_1 = require("./AbstractRestfulClient");
const errors_1 = require("../lib/errors");
const helpers_1 = require("../lib/helpers");
class ManageClient extends AbstractRestfulClient_1.AbstractRestfulClient {
  /**
  ...
  getProjectUsageRequests(projectId, options, endpoint = "v1/projects/:projectId/requests") {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        const url = new URL(this.baseUrl);
        url.pathname = endpoint.replace(/:projectId/, projectId);
        (0, helpers_1.appendSearchParams)(url.searchParams, options);
        const result = yield this.get(this.fetch, url);
        return { result, error: null };
      } catch (error) {
        if ((0, errors_1.isDeepgramError)(error)) {
